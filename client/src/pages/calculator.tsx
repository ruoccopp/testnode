          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 md:space-y-6">
              ...
              <div className="bg-green-50 p-4 rounded-lg mb-6 border-2 border-green-200">
                <h3 className="font-medium text-green-900 mb-4">📊 Gestione IVA 2025</h3>
                <div className="text-sm text-green-700 mb-4">
                  I dati IVA per i versamenti trimestrali del 2025. Le ritenute sono già incluse nei dati economici 2024.
                </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue="REGIME_ORDINARIO">
                          <FormControl>
                            <SelectTrigger>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            ...
                            {...field}
                            onChange={(e) => field.onChange(e.target.value ? parseFloat(e.target.value) : undefined)}
                            value={field.value || Math.round((form.watch('revenue2025') || 0) * 0.22) || ""}
                          />
                        </FormControl>
                        <div className="text-xs text-green-600">
                          Presunto: {new Intl.NumberFormat('it-IT', { style: 'currency', currency: 'EUR' }).format(Math.round((form.watch('revenue2025') || 0) * 0.22))}
                        </div>
                      </FormItem>
                    )}
                  />
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            ...
                            {...field}
                            onChange={(e) => field.onChange(e.target.value ? parseFloat(e.target.value) : undefined)}
                            value={field.value || Math.round((form.watch('revenue2025') || 0) * 0.15) || ""}
                          />
                        </FormControl>
                        <div className="text-xs text-green-600">
                          Presunto: {new Intl.NumberFormat('it-IT', { style: 'currency', currency: 'EUR' }).format(Math.round((form.watch('revenue2025') || 0) * 0.15))}
                        </div>
                      </FormItem>
                    )}
                  />
